...
data2=np.loadtxt("radial0019.dat")
...
#axes.plot(dataFin100[:,0]/au, (dataFin100[:,3]), linewidth=3, color="blue", label="Gas temperature")
axes.plot(data2[:,0]/au, (data2[:,2]), linewidth=3, color="blue", label="Gas temperature")
axes.plot(dataFin100[:,0]/au, (dataFin100[:,4]), linewidth=3, color="red", label="Dust temperature")
...
plt.savefig("Example_Temperature.pdf")
plt.show()
